...
echo validation_errors(); ?>
	...
	Reference Name: <input name="referenceName" type="text"/><br />
	<br />
	First Name: <input name="firstName" type="text" /><br />
	Last Name: <input name="lastName" type="text" /><br />
	Company Name: <input name="companyName" type="text" /><br />
	Email Address: <input name="emailAddr" type="email" /><br />
	<br />
	...
	Postal Code: <input type="text" name="zipcode" /></br />
	...
	No spaces or dashes, just numbers.&nbsp; Include country code and applicable
	area codes.<br />
